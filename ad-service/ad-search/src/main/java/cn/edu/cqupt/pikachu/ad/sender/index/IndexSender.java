package cn.edu.cqupt.pikachu.ad.sender.index;
...
import cn.edu.cqupt.pikachu.ad.index.DataLevel;
...
public class IndexSender implements ISender {
    ...
    public void sender(MySqlRowData rowData) {
        ...
        if (DataLevel.LEVEL2.getLevel().equals(level)) {
            ...
            log.error("ad-search: IndexSender MysqlRowData ERROR: {}", JSON.toJSONString(rowData));
        }
    }
            ...
            for (Map<String, String> fieldValueMap :
                ...
                fieldValueMap.forEach((k, v) -> {
                    try {
                        ...
                        log.error("ad-search:IndexSender Level2RowData -> Time conversion abnormal：{}", e);
                    }
                });
